...
var (
	messageDBTypes = map[string]string{`ID`: `integer`, `CreatedAt`: `timestamp with time zone`, `UpdatedAt`: `timestamp with time zone`, `Name`: `text`, `Email`: `text`, `Phone`: `text`, `Subject`: `text`, `Message`: `text`}
	_              = bytes.MinRead
)
