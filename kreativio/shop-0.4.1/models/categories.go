...
var CategoryWhere = struct {
	...
	ID:          whereHelperint{field: "\"shop\".\"categories\".\"id\""},
	CreatedAt:   whereHelpertime_Time{field: "\"shop\".\"categories\".\"created_at\""},
	UpdatedAt:   whereHelpertime_Time{field: "\"shop\".\"categories\".\"updated_at\""},
	Label:       whereHelperstring{field: "\"shop\".\"categories\".\"label\""},
	Position:    whereHelperint{field: "\"shop\".\"categories\".\"position\""},
	SearchIndex: whereHelpernull_String{field: "\"shop\".\"categories\".\"search_index\""},
}
...
var (
	categoryAllColumns            = []string{"id", "created_at", "updated_at", "label", "position", "search_index"}
	categoryColumnsWithoutDefault = []string{"created_at", "updated_at", "label", "position", "search_index"}
...
func (o *Category) Articles(mods ...qm.QueryMod) articleQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"shop\".\"category_articles\" on \"shop\".\"articles\".\"id\" = \"shop\".\"category_articles\".\"article_id\""),
		qm.Where("\"shop\".\"category_articles\".\"category_id\"=?", o.ID),
	)
...
func (categoryL) LoadArticles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCategory interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"shop\".\"articles\".*, \"a\".\"category_id\""),
		qm.From("\"shop\".\"articles\""),
		qm.InnerJoin("\"shop\".\"category_articles\" as \"a\" on \"shop\".\"articles\".\"id\" = \"a\".\"article_id\""),
...
func (o *Category) AddArticles(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Article) error {
	...
	for _, rel := range related {
		query := "insert into \"shop\".\"category_articles\" (\"category_id\", \"article_id\") values ($1, $2)"
...
// Sets o.R.Categories's Articles accordingly.
// Replaces o.R.Articles with related.
// Sets related.R.Categories's Articles accordingly.
func (o *Category) SetArticles(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Article) error {
	query := "delete from \"shop\".\"category_articles\" where \"category_id\" = $1"
	...
	removeArticlesFromCategoriesSlice(o, related)
	if o.R != nil {
		o.R.Articles = nil
	}
...
func (o *Category) RemoveArticles(ctx context.Context, exec boil.ContextExecutor, related ...*Article) error {
	var err error
	query := fmt.Sprintf(
		"delete from \"shop\".\"category_articles\" where \"category_id\" = $1 and \"article_id\" in (%s)",
...
func removeArticlesFromCategoriesSlice(o *Category, related []*Article) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
...
func Categories(mods ...qm.QueryMod) categoryQuery {
	mods = append(mods, qm.From("\"shop\".\"categories\""))
...
func FindCategory(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Category, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"shop\".\"categories\" where \"id\"=$1", sel,
	)
...
func (o *Category) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"shop\".\"categories\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"shop\".\"categories\" %sDEFAULT VALUES%s"
		}
...
func (o *Category) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"shop\".\"categories\" SET %s WHERE %s",
...
func (o CategorySlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"shop\".\"categories\" SET %s WHERE %s",
...
func (o *Category) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"shop\".\"categories\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *Category) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"shop\".\"categories\" WHERE \"id\"=$1"
...
func (o CategorySlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"shop\".\"categories\" WHERE " +
...
func (o *CategorySlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"shop\".\"categories\".* FROM \"shop\".\"categories\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, categoryPrimaryKeyColumns, len(*o))
...
func CategoryExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"shop\".\"categories\" where \"id\"=$1 limit 1)"
