...
var MessageWhere = struct {
	...
	ID:        whereHelperint{field: "\"shop\".\"messages\".\"id\""},
	CreatedAt: whereHelpertime_Time{field: "\"shop\".\"messages\".\"created_at\""},
	UpdatedAt: whereHelpertime_Time{field: "\"shop\".\"messages\".\"updated_at\""},
	Name:      whereHelperstring{field: "\"shop\".\"messages\".\"name\""},
	Email:     whereHelperstring{field: "\"shop\".\"messages\".\"email\""},
	Phone:     whereHelperstring{field: "\"shop\".\"messages\".\"phone\""},
	Subject:   whereHelperstring{field: "\"shop\".\"messages\".\"subject\""},
	Message:   whereHelperstring{field: "\"shop\".\"messages\".\"message\""},
}
...
var (
	messageAllColumns            = []string{"id", "created_at", "updated_at", "name", "email", "phone", "subject", "message"}
	messageColumnsWithoutDefault = []string{"created_at", "updated_at", "name", "email", "phone", "subject", "message"}
...
func Messages(mods ...qm.QueryMod) messageQuery {
	mods = append(mods, qm.From("\"shop\".\"messages\""))
...
func FindMessage(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Message, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"shop\".\"messages\" where \"id\"=$1", sel,
	)
...
func (o *Message) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"shop\".\"messages\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"shop\".\"messages\" %sDEFAULT VALUES%s"
		}
...
func (o *Message) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"shop\".\"messages\" SET %s WHERE %s",
...
func (o MessageSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"shop\".\"messages\" SET %s WHERE %s",
...
func (o *Message) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"shop\".\"messages\"", updateOnConflict, ret, update, conflict, insert)
...
func (o *Message) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"shop\".\"messages\" WHERE \"id\"=$1"
...
func (o MessageSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"shop\".\"messages\" WHERE " +
...
func (o *MessageSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"shop\".\"messages\".* FROM \"shop\".\"messages\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, messagePrimaryKeyColumns, len(*o))
...
func MessageExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"shop\".\"messages\" where \"id\"=$1 limit 1)"
